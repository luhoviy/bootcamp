...
import { CREATE_ARTICLE_FAILURE, CREATE_ARTICLE_SUCCESS, createArticle } from "../../../store";
...
export class CreateArticleComponent extends ClearObservable {
  ...
  createArticle(article: Article): void {
    ...
    this.actions$
      .pipe(ofType(CREATE_ARTICLE_SUCCESS, CREATE_ARTICLE_FAILURE), take(1), takeUntil(this.destroy$))
      .subscribe(({ type }) => {
